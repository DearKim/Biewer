// Minimal column-major 4x4 matrix + vec3 helpers for the WebGL volume camera.
// (Self-contained; avoids a gl-matrix dependency in the shipped package.)
...
/** Orbit eye position around origin: azimuth/elevation (radians) at `dist`. */
export function orbitEye(az: number, el: number, dist: number): Vec3 {
